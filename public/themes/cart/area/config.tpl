					...
					<div class="form-group row">   
						...
						<div class="col-md-10"> 
							<div class="btn-group btn-group-toggle cycle mt-2 mt-xl-0" data-toggle="buttons">
								...
								<label class="btn btn-primary btn-sm active" style="position: relative;">
									<input type="radio" name="billingcycle" value="{$cycle.billingcycle}" {if $CartConfig.billingcyle==$cycle.billingcycle}checked=""{elseif $cycle_key==0 && !$CartConfig.config_options && !$addParam.billingcycle /}checked="" {elseif $addParam.billingcycle==$cycle.billingcycle && !$CartConfig.config_options} checked="" {/if}>{$cycle.billingcycle_zh}
									{if $cycle.discount}
...
<!-- select -->
<link rel="stylesheet" href="{$Setting.web_url}/themes/cart/default/assets/js/bootstrap-select/css/bootstrap-select.min.css?v={$Ver}">
<script src="{$Setting.web_url}/themes/cart/default/assets/js/bootstrap-select/js/bootstrap-select.min.js?v={$Ver}"></script>
<!-- slider -->
<link rel="stylesheet" href="{$Setting.web_url}/themes/cart/default/assets/js/ion-rangeslider/css/ion.rangeSlider.min.css?v={$Ver}">
...
<script src="{$Setting.web_url}/themes/cart/default/assets/js/configureproduct.js"></script>
