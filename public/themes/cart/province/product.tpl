...
<link rel="stylesheet" href="{$Setting.web_url}/themes/cart/province/assets/fonts/iconfont.css?v={$Ver}">
<div class="card">
      ...
      <div class="col-sm-3 mb-3">
        <div class="card cartitem">
          <div class="card-body row">
            ...
            <div class="col-sm-12">
              ...
              {if $list.stock_control==1 && $list.qty<1} 
                ...
                <img src="{$Setting.web_url}/themes/cart/province/assets/img/saleout.svg" style="position: absolute;top: -40px;right: 20px;width: 50px;" alt="">
                {else /}
          ...
          <div class="card-footer text-center p-0" style="box-shadow: 0px 4px 20px 2px rgba(6, 75, 179, 0.08);">
            {if $list.stock_control==1 && $list.qty<1} 
            <a href="javescript:;" style="cursor: not-allowed">{$Lang.buy_now}</a>
            {else}
