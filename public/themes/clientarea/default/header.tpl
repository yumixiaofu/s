...
<meta http-equiv="Content-Security-Policy" content="script-src 'self'; object-src 'none'; style-src cdn.example.org third-party.org; child-src https:">-->
  ...
  var setting_web_url = 'https://g.sheliyun.com';
  var language=null;
 /* 
			...
			<div class="d-flex">
				...
				<div class="navbar-brand-box">
					<a href="{$Setting.web_jump_url}" class="logo logo-dark">
						<span class="logo-sm">
							<img src="{$Setting.system_url}/{$Setting.web_logo_home}" alt="" height="22">
						</span>
						<span class="logo-lg">
							<img src="{$Setting.system_url}/{$Setting.web_logo_home}" alt="" height="17">
						</span>
					</a>
					...
					<a href="{$Setting.web_jump_url}" class="logo logo-light">
						...
						<span class="logo-lg">
							<img src="{$Setting.system_url}/{$Setting.web_logo_home}" alt="">
						</span>
					</a>
				</div>
			...
			<div class="d-flex">
				...
				<div class="dropdown d-inline-block">
					<button type="button" class="btn header-item waves-effect" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">
						<img id="header-lang-img" src="{$Setting.web_url}/upload/common/country/{$LanguageCheck.display_flag}.png" alt="Header Language" height="16">
					</button>
