          ...
          <div class="table-responsive" style="min-height:auto;border-radius: 0px 0px calc(.25rem - 1px) calc(.25rem - 1px);">
            <table class="table mb-0" style="border:#ddd 1px solid">
              <thead class="card-header px-3">
                <tr>
                  <td class="border-top-0" style="width:80%"><strong>账单详情</strong></td>
                  <td class="text-center border-top-0" style="width:5%"><strong>类型</strong></td>
                  <td class="text-center border-top-0" style="width:15%"><strong>金额</strong></td>
                </tr>
              </thead>
              <tbody>
