...
{if $Verified.certifi_message.status == '4' && $Verified.plugin != 'artificial'}
	...
	<div class="card">
		<div class="card-body text-center">
			<h1 class="pt-4 font-weight-bold"><img src="http://w2.test.idcsmart.com/themes/clientarea/default/assets_custom/img/Certification_pass.png" alt=""> 申请资料已提交！</h1>
...
{elseif $Think.get.action == 'personal' && $Think.get.step == 'info'}
	...
	$(function () {
		...
		$('input:radio[name="card_type"]').on('change', function () {
			...
			location.replace('/verified?action={$Think.get.action}&type=' + ($(this).val() == '0' ? 'other' : ''))
		});
	})
					...
					<form class="needs-validation w-100" novalidate method="post" enctype="multipart/form-data">
						...
						{foreach $Verified.certifi_select as $certifi_select_key=>$certifi_select_val}
							<div class="certifi_select" id="certifi_select{$certifi_select_key}" style="display:none;">
								{foreach $certifi_select_val.custom_fields as $custom_fields}
									<div class="form-group row mb-4 w-100">
	...
	$('input[type=radio][name=card_type]').change(function () {
		if (this.value == '2') {
			location.replace('verified?action=personal&type=other')
		}
	});
</script>
	<!-- 弹窗 -->
...
<!-- 待审核 -->
{elseif $Verified.certifi_message.status == '3'}
<div class="card ststus-box">
	<div class="card-body p-5">
		<div class="container-fluid mt-5">
			<div class="row">
...
<!-- </div> -->
<script type="text/javascript" src="{$Setting.web_url}/themes/clientarea/default/assets/js/verified.js?v={$Ver}"></script>