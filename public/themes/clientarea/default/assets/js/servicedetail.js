      ...
      success: function (res) {
        if (res.status == 200) {
          if (typeof res.data != 'undefined' && typeof res.data.task_type != 'undefined') {
            ...
            $('#powerBox').html('<span class="bx bx-loader" data-toggle="popover" data-trigger="hover" title="" data-html="true" data-content="' + res.data.step + '"></span>')
