                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                {foreach name="data" item="dd"}
                                    <tr>
                                        ...
                                        <td class="center">￥{$dd.amount_in}元</td>
                                        <td class="center">{$dd.sale_id}</td>
                                        <td>账单：{$dd.invoice_id}<br/>流水号：{$dd.trans_id}</td>
                                        <td class="center">
                                            {if $dd.type == 'recharge'}充值{elseif $dd.type == 'renew'}续费{elseif $dd.type
                                            == 'host'}产品{/if}</td>
                                        <td>
